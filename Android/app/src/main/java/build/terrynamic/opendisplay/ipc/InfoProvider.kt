...
import build.terrynamic.opendisplay.BuildConfig
...
class InfoProvider : ContentProvider() {
    ...
    override fun getType(uri: Uri): String = "vnd.android.cursor.item/vnd.build.terrynamic.opendisplay.info"
    ...
    companion object {
        const val AUTHORITY = "build.terrynamic.opendisplay.info"
    }
}
